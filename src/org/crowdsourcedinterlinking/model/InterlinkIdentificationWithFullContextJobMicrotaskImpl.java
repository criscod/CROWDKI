 ...
 * @author csarasua
 */
public class InterlinkIdentificationWithFullContextJobMicrotaskImpl extends
        InterlinkIdentificationJobMicrotaskImpl {

    public InterlinkIdentificationWithFullContextJobMicrotaskImpl(
            ...
            if (this.extended) {
                if (!turned) {
                    ...
                    cmlFile = new File(ConfigurationManager.getInstance()
                            .getInterlinkIdentificationFullContextFile());
                } else {
                    cmlFile = new File(ConfigurationManager.getInstance()
                            .getInterlinkIdentificationFullContextTurnedFile());
                }
            } /* not needed anymore
            else {
